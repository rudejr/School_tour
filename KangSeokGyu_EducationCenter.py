...
pygame.display.set_caption("KangSeokGyu_EducationCenter")
...
# 이미지 관리
imageZip = {
    'DefaultImg' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_elevatorImg.jpg"), (620, 820)),
    'img5' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_5F\_hallway.jpg"), (740, 500)),
    'img4' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_4F\_hallway.jpg"), (740, 500)),
    'img3' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_3F\_hallway.jpg"), (740, 500)),
    'img2' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_2F\_hallway.jpg"), (740, 500)),
    'img1' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_1F\_hallway.jpg"), (740, 500)),
    'img0' : pygame.transform.scale(pygame.image.load(".\img\KangSeokGyuEdu\_1B\_hallway.jpg"), (740, 500)),
}

# 텍스트 관리
textZip = {
    'buildingsName' : font_text.render("강석규 교육관", True, (255, 255, 255)),
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            ...
            if is_button_clicked(button_x5, button_y5, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "대강의실", "image_path" : ".\img\KangSeokGyuEdu\_5F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "열람실", "image_path" : ".\img\KangSeokGyuEdu\_5F\_readingRoom.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "MOT", "image_path" : ".\img\KangSeokGyuEdu\_5F\_mot.jpg"},
                    {"x" : 900,  "y" : 820, "text" : "세미나실", "image_path" : ".\img\KangSeokGyuEdu\_5F\_seminarRoom1.jpg"},
                    {"x" : 1150, "y" : 820, "text" : "세미나실", "image_path" : ".\img\KangSeokGyuEdu\_5F\_seminarRoom2.jpg"},
            ...
            if is_button_clicked(button_x4, button_y4, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_4F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "학습공간", "image_path" : ".\img\KangSeokGyuEdu\_4F\_learningSpace.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "빅데이터학부 PC실", "image_path" : ".\img\KangSeokGyuEdu\_4F\_aiRoom.jpg"},
            ...
            if is_button_clicked(button_x3, button_y3, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_3F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_3F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_3F\_lectureRoom3.jpg"},
                    {"x" : 900,  "y" : 820, "text" : "휴식공간", "image_path" : ".\img\KangSeokGyuEdu\_3F\_rest.jpg"},
                    {"x" : 1150, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1400, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                ]
            if is_button_clicked(button_x2, button_y2, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "회의실", "image_path" : ".\img\KangSeokGyuEdu\_2F\_meetingRoom.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "자연사 박물관", "image_path" : ".\img\KangSeokGyuEdu\_2F\_museum.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_2F\_lectureRoom1.jpg"},
                    {"x" : 900,  "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1150, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1400, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                ]
            if is_button_clicked(button_x1, button_y1, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "설립자 동상", "image_path" : ".\img\KangSeokGyuEdu\_1F\_founder.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "휴식공간", "image_path" : ".\img\KangSeokGyuEdu\_1F\_rest.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "취업팀", "image_path" : ".\img\KangSeokGyuEdu\_1F\_employmentTeam.jpg"},
                    {"x" : 900,  "y" : 820, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_1F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 820, "text" : "강의실", "image_path" : ".\img\KangSeokGyuEdu\_1F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 820, "text" : "ATM기", "image_path" : ".\img\KangSeokGyuEdu\_1F\_ATM.jpg"},
                ]
            if is_button_clicked(button_x0, button_y0, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "카페드림", "image_path" : ".\img\KangSeokGyuEdu\_1B\_cafe.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "서점", "image_path" : ".\img\KangSeokGyuEdu\_1B\_bookStore.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "프린트실", "image_path" : ".\img\KangSeokGyuEdu\_1B\_printRoom.jpg"},
                    {"x" : 900,  "y" : 820, "text" : "편의점", "image_path" : ".\img\KangSeokGyuEdu\_1B\_convenienceStore.jpg"},
                    {"x" : 1150, "y" : 820, "text" : "생활용품점", "image_path" : ".\img\KangSeokGyuEdu\_1B\_householdStore.jpg"},
                    {"x" : 1400, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                ]
