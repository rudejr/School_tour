...
pygame.display.set_caption("Church")
...
# 이미지 관리
imageZip = {
    'DefaultImg' : pygame.transform.scale(pygame.image.load(".\img\\Church\_outside.jpg"), (620, 820)),
    'subImg' : pygame.transform.scale(pygame.image.load(".\img\Church\_internal.jpg"), (740, 750)),
}

# 텍스트 관리
textZip = {
    'buildingsName' : font_text.render("대학교회", True, (255, 255, 255)),
    'subName' : font_text.render("대학교회(내부)", True, (255, 255, 255)),
}
...
while running:
    ...
    screen.blit(textZip['subName'], (880, 140))
    
    # 출력 이미지 관리
    screen.blit(imageZip['DefaultImg'], (100, 120))
    screen.blit(imageZip['subImg'], (880, 190))
