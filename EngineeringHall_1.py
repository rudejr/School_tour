...
pygame.display.set_caption("EngineeringHall_1")
...
# 이미지 관리
imageZip = {
    'DefaultImg' : pygame.transform.scale(pygame.image.load(".\img\EngineeringHall_1\_stairs.jpg"), (620, 820)),
    'img5' : pygame.transform.scale(pygame.image.load(".\img\EngineeringHall_1\_5F\_hallway.jpg"), (740, 500)),
    'img4' : pygame.transform.scale(pygame.image.load(".\img\EngineeringHall_1\_4F\_hallway.jpg"), (740, 500)),
    'img3' : pygame.transform.scale(pygame.image.load(".\img\EngineeringHall_1\_3F\_hallway.jpg"), (740, 500)),
    'img2' : pygame.transform.scale(pygame.image.load(".\img\EngineeringHall_1\_2F\_hallway.jpg"), (740, 500)),
    'img1' : pygame.transform.scale(pygame.image.load(".\img\EngineeringHall_1\_1F\_hallway.jpg"), (740, 500)),
}

# 텍스트 관리
textZip = {
    'buildingsName' : font_text.render("제 1공학관", True, (255, 255, 255)),
...
button_coordinates = [(800, 820), (800, 720), (800, 620), (800, 520), (800, 420)]
button_x5, button_y5 = button_coordinates[4]
button_x4, button_y4 = button_coordinates[3]
button_x3, button_y3 = button_coordinates[2]
button_x2, button_y2 = button_coordinates[1]
button_x1, button_y1 = button_coordinates[0]
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            ...
            if is_button_clicked(button_x5, button_y5, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "대강의실", "image_path" : ".\img\EngineeringHall_1\_5F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_5F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_5F\_lectureRoom3.jpg"},
                    {"x" : 900,  "y" : 820, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_5F\_lectureRoom4.jpg"},
                    {"x" : 1150, "y" : 820, "text" : "휴게실", "image_path" : ".\img\EngineeringHall_1\_5F\_rest.jpg"},
            ...
            if is_button_clicked(button_x4, button_y4, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_4F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_4F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_4F\_lectureRoom3.jpg"},
            ...
            if is_button_clicked(button_x3, button_y3, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_3F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_3F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_3F\_lectureRoom3.jpg"},
                    {"x" : 900,  "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1150, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1400, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                ]
            if is_button_clicked(button_x2, button_y2, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_2F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_2F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_2F\_lectureRoom3.jpg"},
                    {"x" : 900,  "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1150, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1400, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                ]
            if is_button_clicked(button_x1, button_y1, button_radius, mouse_pos):
                ...
                roomData = [
                    {"x" : 900,  "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_1F\_lectureRoom1.jpg"},
                    {"x" : 1150, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_1F\_lectureRoom2.jpg"},
                    {"x" : 1400, "y" : 720, "text" : "강의실", "image_path" : ".\img\EngineeringHall_1\_1F\_lectureRoom3.jpg"},
                    {"x" : 900,  "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1150, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                    {"x" : 1400, "y" : 820, "text" : " ", "image_path" : ".\img\_blank.jpg"},
                ]
